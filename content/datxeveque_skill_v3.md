...
# SKILL: Viết bài Facebook cho DatXeVeQue.vn (Group + Fanpage) — v2.1
...
Trigger: "xuất file", "xuất Excel", "tạo file", "export", "import website", hoặc số lượng bài lớn (từ 10 bài trở lên).
...
| "Group, SG→Đức Linh, Chợ Võ Xu + Mê Pu, có ảnh" | Viết 1 bài Group → hỏi "Tạo ảnh" |
...
| "Fanpage, Tánh Linh, Gia An + Suối Kiết, có ảnh" | Làm 1 bài Fanpage → hỏi "Tạo ảnh" |
| "Group, Đức Linh lên SG, tự chọn, không" | Chiều ngược → hook "lên Sài Gòn" → tự chọn địa danh → làm 1 bài Group |
| "Thêm bài đi chợ quê" | Tự hiểu Fanpage + tuyến phù hợp → viết bài góc chợ quê |
| "Viết bài gửi hàng" | Tự hiểu Fanpage + tuyến phù hợp → viết bài góc gửi hàng 2 chiều |
...
Về quê thăm nhà, ghé chợ, gửi chút quà cho người thân — nhắn Zalo **0962100600** hoặc gõ **DatXeVeQue.vn**.
...
Cần gửi hàng hoặc đặt xe thì nhắn Zalo **0962100600** hoặc gõ **DatXeVeQue.vn**.
